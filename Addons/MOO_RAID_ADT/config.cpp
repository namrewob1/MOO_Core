...
{
    class MOO_RAID_ADT //Faction Calling Name
    {
         displayName = "MOO Raiders (ADT)"; //Faction name in-game
         icon = "\MOO_RAID_ADT\UI\MOO_Logo_256.paa"; //Path to texture next to the faction name in editor "PBOname\filename.paa"
...
class CfgVehicles
{
    class MOO_Core_ADT_Base;
    class MOO_RAID_ADT_PM: MOO_Core_ADT_Base       // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        ...
        backpack = "MOO_RAID_ADT_PM_Bag";        // Which backpack the character is wearing.
	...
	class MOO_Core_ADT_Base_SS;
	class MOO_RAID_ADT_LG: MOO_Core_ADT_Base_SS      // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
        ...
        picture = "";              // The same as above, but for the squad picture.
		vehicleclass = "MOO_Men"; //Unit Group
        backpack = "MOO_RAID_ADT_LG_Bag";        // Which backpack the character is wearing.
	...
	class MOO_RAID_ADT_SG: MOO_Core_ADT_Base_SS      // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
        ...
        picture = "";              // The same as above, but for the squad picture.
		vehicleclass = "MOO_Men"; //Unit Group
        backpack = "MOO_RAID_ADT_SG_Bag";        // Which backpack the character is wearing.
	...
	class MOO_RAID_ADT_HG: MOO_Core_ADT_Base      // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
        ...
        picture = "";              // The same as above, but for the squad picture.
		vehicleclass = "MOO_Men"; //Unit Group
        backpack = "MOO_RAID_ADT_HG_Bag";        // Which backpack the character is wearing.
	...
	class MOO_RAID_ADT_AHG: MOO_Core_ADT_Base       // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
	...
	class MOO_RAID_ADT_AB: MOO_Core_ADT_Base       // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
        ...
        picture = "";              // The same as above, but for the squad picture.
		vehicleclass = "MOO_Men"; //Unit Group
        backpack = "MOO_RAID_ADT_AB_Bag";        // Which backpack the character is wearing.
        weapons[] = {hlc_rifle_ACR68_Carb_black_rd_pointer, hlc_pistol_P226R_Elite_pointer, Throw, Put};               // Which weapons the character has.
        respawnWeapons[] = {hlc_rifle_ACR68_Carb_black_rd_pointer, hlc_pistol_P226R_Elite_pointer, Throw, Put};        // Which weapons the character respawns with.
        Items[] = {FirstAidKit, FirstAidKit, FirstAidKit, FirstAidKit, ACE_IR_Strobe_Item, ACE_NVG_Gen1};                // Which items the character has.
        RespawnItems[] = {FirstAidKit, FirstAidKit, FirstAidKit, FirstAidKit, ACE_IR_Strobe_Item, ACE_NVG_Gen1};         // Which items the character respawns with.
	...
	class MOO_RAID_ADT_CM: MOO_Core_ADT_Base       // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		...
		vehicleclass = "MOO_Men"; //Unit Group
        backpack = "MOO_RAID_ADT_CM_Bag";        // Which backpack the character is wearing.
	...
	class MOO_RAID_ADT_CT: MOO_Core_ADT_Base       // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
	...
	class MOO_RAID_ADT_CAT: MOO_Core_ADT_Base       // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
	...
	class MOO_RAID_ADT_MM: MOO_Core_ADT_Base_SS       // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
	...
	class MOO_RAID_ADT_SP: MOO_Core_ADT_Base       // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		...
		vehicleclass = "MOO_Men"; //Unit Group
        backpack = "MOO_RAID_ADT_SP_Bag";        // Which backpack the character is wearing.
        weapons[] = {hlc_rifle_ACR68_SBR_black_rd_pointer, hlc_pistol_P226R_Elite_pointer, Throw, Put};               // Which weapons the character has.
        respawnWeapons[] = {hlc_rifle_ACR68_SBR_black_rd_pointer, hlc_pistol_P226R_Elite_pointer, Throw, Put};        // Which weapons the character respawns with.
        Items[] = {FirstAidKit, FirstAidKit, FirstAidKit, FirstAidKit, ACE_IR_Strobe_Item, ACE_NVG_Gen1};                // Which items the character has.
        RespawnItems[] = {FirstAidKit, FirstAidKit, FirstAidKit, FirstAidKit, ACE_IR_Strobe_Item, ACE_NVG_Gen1};         // Which items the character respawns with.
	...
	class MOO_RAID_ADT_FAC: MOO_Core_ADT_Base       // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
	...
	class MOO_RAID_ADT_PL: MOO_Core_ADT_Base_SS       // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
        ...
        picture = "";              // The same as above, but for the squad picture.
		vehicleclass = "MOO_Men"; //Unit Group
        backpack = "MOO_Core_ADT_KB";        // Which backpack the character is wearing.
	...
	class MOO_RAID_ADT_SS: MOO_Core_ADT_Base_SS       // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
        ...
        picture = "";              // The same as above, but for the squad picture.
		vehicleclass = "MOO_Men"; //Unit Group
        backpack = "MOO_RAID_ADT_SS_Bag";        // Which backpack the character is wearing.
        ...
        linkedItems[] = {milgp_v_marciras_marksman_belt_cb, milgp_h_cap_03_CB, ItemMap, ItemCompass, tf_microdagr, tf_anprc152, ItemGPS};               // Which items the character has.
        respawnLinkedItems[] = {milgp_v_marciras_marksman_belt_cb, milgp_h_cap_03_CB, ItemMap, ItemCompass, tf_microdagr, tf_anprc152, ItemGPS};        // Which items the character respawns with.
    };
	
	class MOO_RAID_ADT_SPT: MOO_Core_ADT_Base_SS       // Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
    {
        author = "Nam - MOO";         // The name of the author of the asset, which is displayed in the editor.
		faction = "MOO_RAID_ADT"; //Your Faction
        scope = 2;                          // 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
        ...
        picture = "";              // The same as above, but for the squad picture.
		vehicleclass = "MOO_Men"; //Unit Group
        backpack = "tf_rt1523g_big_bwmod_tropen";        // Which backpack the character is wearing.
        ...
        linkedItems[] = {milgp_v_marciras_assaulter_belt_cb, H_Booniehat_tan, ItemMap, ItemCompass, tf_microdagr, tf_anprc152, ItemGPS};               // Which items the character has.
        respawnLinkedItems[] = {milgp_v_marciras_assaulter_belt_cb, H_Booniehat_tan, ItemMap, ItemCompass, tf_microdagr, tf_anprc152, ItemGPS};        // Which items the character respawns with.
    };
...
// Invis Backpacks
	...
	class MOO_Core_ADT_KB;
	class MOO_RAID_ADT_LG_Bag: MOO_Core_ADT_KB
    {
        scope = 1;      
	...
	class MOO_Core_ADT_DS;
	class MOO_RAID_ADT_AB_Bag: MOO_Core_ADT_DS
    {
        scope = 1;      
        class TransportMagazines
        {
	...
	class MOO_RAID_ADT_SG_Bag: MOO_Core_ADT_DS
    {
        scope = 1;      
        class TransportMagazines
        {
	...
	class MOO_RAID_ADT_HG_Bag: MOO_Core_ADT_DS
    {
        scope = 1;      
        class TransportMagazines
        {
	...
	class MOO_Core_ADT_AS;
	class MOO_RAID_ADT_CM_Bag: MOO_Core_ADT_AS
    {
        scope = 1;      
	...
	class MOO_RAID_ADT_SP_Bag: MOO_Core_ADT_AS
    {
        scope = 1;      
        class TransportItems
		{
	...
	class MOO_RAID_ADT_PM_Bag: milgp_bp_Pointman_cb
    {
        scope = 1;      
        class TransportItems
		{
	...
	class ace_gunbag;
	class MOO_RAID_ADT_SS_Bag: ace_gunbag
    {
        scope = 1;
		maximumLoad = 250;	
